...
int main(int argc, char** argv)
{
  ...
  float campos[3] = {0,-80,-20};
  float camrot[3] = {60,0,0};
  pCameraEntity->ApplyDeltaRotate(camrot);
  ...
  float control2[3] = {0,0,100};
  float control3[3] = {100,0,100};
  float control4[3] = {100,0,0};

  float control5[3] = {100,0,0};
  float control6[3] = {100,0,-100};
  float control7[3] = {0,0,-100};
